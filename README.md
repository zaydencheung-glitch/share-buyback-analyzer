...
An independent research project analyzing the relationship between corporate share buybacks and changes in diluted weighted-average share count.

## 1\. Project Title

**Share Buyback Analyzer: Measuring Net Diluted Share-Count Change Across Ten Public Companies**

## 2\. Research Question

> Are corporate share buybacks associated with lower diluted weighted-average
...
year to the next? Diluted weighted-average shares reflect the combined effects

of buybacks and share issuance in a single figure — this project does not
...
Share buybacks are often discussed as a way for companies to reduce their share count. However, companies can also issue new shares through stock-based compensation and other forms of equity issuance, which can partially or fully offset the effect of repurchases. A company can spend billions of dollars buying back stock and still end the year with the same or a higher diluted share count. This project builds a small, reproducible
...
1\. Retrieve financial statement data through `yfinance`, including Diluted Weighted-Average Shares and, where available, Basic Average Shares, repurchase spending, and stock-based compensation.
...
8\. Compare the ten companies and generate the final CSV files and charts.
...
10-K (see "Current Verification Status" below).
...
* **Diluted Weighted-Average Shares** — a *weighted average* of shares outstanding
...
derived measures of the year-over-year *change* in diluted weighted-average
...
```
Net Shares Retired = Previous Year Diluted Weighted-Average Shares
                      − Current Year Diluted Weighted-Average Shares
```
...
* Positive → diluted weighted-average share count decreased that year.
* Negative → diluted weighted-average share count increased (net dilution) that year.
* Values within ±0.10 percentage points are classified as "Flat / Neutral."

**Cumulative percentage change in diluted weighted-average shares** (across the
...
```
Cumulative % Change = (Last Year Diluted Weighted-Average Shares − First Year Diluted Weighted-Average Shares)
                       / First Year Diluted Weighted-Average Shares × 100
```
...
* Whether the required field (Diluted Weighted-Average Shares) exists at all for
that fiscal year.
...
a gap (e.g., comparing 2024 directly to 2022 when 2023 is missing).
...
The final analysis includes ten companies across FY2022 through FY2025. Six companies showed an overall net reduction in diluted weighted-average shares, three showed net dilution, and one was classified as Flat / Neutral.

Detailed results are available in:

\- data/processed/net\_buyback\_yield\_all\_companies.csv — year-by-year results for all ten companies.

\- data/processed/company\_summary.csv — company-level summary and aggregate metrics.

\- reports/research\_report.md — full research report explaining the methodology, results, interpretation, and limitations.
...
* **Diluted weighted-average shares is an accounting measure**, not a literal
...
Supporting fields sourced through yfinance, including repurchase spending and stock-based compensation, should be treated as provisional unless separately verified.
...
Diluted weighted-average share observations used in the final analysis have been checked against official SEC filings. Supporting fields retrieved through yfinance, including repurchase spending and stock-based compensation, should still be treated as provisional unless separately verified.
...
│   └── processed/               # Cleaned per-year table + company summary (CSV)
├── charts/                      # Generated PNG charts
├── reports/
│   └── research\_report.md       # Completed research report
└── tests/
...
Diluted weighted-average share observations for all ten companies from FY2022 through FY2025 have been checked against official SEC filings. Supporting variables, including repurchase spending and stock-based compensation, remain provisional unless otherwise noted.
...
| Apple (AAPL) | Verified | FY2022–FY2025 diluted weighted-average shares verified against SEC filings. FY2022 repurchase spending has a documented presentation difference between the SEC filing and the automated supporting field; this does not affect the diluted-share analysis. |

| Microsoft (MSFT) | Verified | FY2022–FY2025 diluted weighted-average shares verified against SEC filings. FY2022 uses a verified SEC fallback because the required year was not returned by `yfinance`. |

| NVIDIA (NVDA) | Verified | FY2022–FY2025 diluted weighted-average shares verified against SEC filings. FY2022 is adjusted to a comparable basis for NVIDIA's 2024 10-for-1 stock split, consistent with NVIDIA's retrospective adjustment of share amounts. |
...
This is an educational research project built to explore a specific, narrow accounting question. It is not investment advice or professional financial analysis. Diluted weighted-average share observations used as the primary variable have been checked against official SEC filings. Supporting fields retrieved through yfinance, including repurchase spending and stock-based compensation, should still be treated as provisional.
